...
CREATE PROCEDURE [dbo].[Sp_GetPropertyList] (
	...
	@FromfundToClose nvarchar(50)=null,--5
	@TofundToClose nvarchar(50)=null,--6
	@ZipCode nvarchar(max)=null,--7
	@BuildingMinSF nvarchar(max)=null,--8
	@BuildingMaxSF nvarchar(max)=null,--9   
	@LandMinAcres nvarchar(max)=null,-- 10      
	@LandMaxAcres nvarchar(max)=null,-- 11   
	@UnitBedsMin nvarchar(max)=null,--12
	@UnitBedsMax nvarchar(max)=null,--13
	@Keyword nvarchar(max)=null,--14
	@EnteredDate nvarchar(max)=null,--15
	@ReidyId nvarchar(max)=null,--16
	@YearBuiltMin nvarchar(max)=null,--17
	@YearBuiltMax nvarchar(max)=null,--18
...
SET NOCOUNT ON;
		...
		AND(
		  ...
		  AND(
				 @PropertyTypeList is Null OR prop.PropertyTypeId in(SELECT VALUE FROM string_split(@PropertyTypeList,','))
				 )
			AND(
