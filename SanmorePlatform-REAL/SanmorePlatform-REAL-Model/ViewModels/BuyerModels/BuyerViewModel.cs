...
namespace SanmorePlatform_REAL_Model.ViewModels.BuyerModels
{
    public class BuyerViewModel
    {
        ...
        public int[]? DeleteWorkExperience { get; set; }
        public int[]? DeleteRealEstate { get; set; }
        public int[]? DeleteLoanAndNote { get; set; }
        public int[]? DeleteBuisnessOwned { get; set; }
        public int[]? DeleteAssets { get; set; }
        public int[]? DeleteOtherDebts { get; set; }
        public int[]? DeleteBankDocuments { get; set; }
        public int[]? DeleteCreditDocuments { get; set; }
        public int[]? DeletePassportDocuments { get; set; }
